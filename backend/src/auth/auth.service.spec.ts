...
describe("AuthService", () => {
  ...
  let mockUsersRepository = {
    ...
    createQueryBuilder: jest.fn(() => ({
        ...
        getOne: jest.fn().mockResolvedValue({id: 1, email: 'test@gmail.com', password: '$argon2id$v=19$m=65536,t=3,p=4$BSSdSR/bWwEtdxRgCtFB2w$GuVOU23vhrL9xbzlRFOKd+N7pyhlFVOItnGHXs7MoO4'})
    })),
