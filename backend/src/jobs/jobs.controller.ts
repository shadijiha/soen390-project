...
export class JobsController {
  ...
  //update job post
  @Put(':id')
  async updateJob(@AuthUser() authedUser: BearerPayload, @Body() job: Jobs.UpdateJobRequest, @Param('id') id: number): Promise<void> {
    ...
    await this.usersService.updateJob(id, job, recruiter);
