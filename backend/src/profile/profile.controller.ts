...
export class ProfileController {
  ...
  public async addEducation(
    ...
    try {
      this.profileService.addEducation(
        await userInfo.getUser(["educations"]),
        body
      );
    } catch (e) {
  ...
  public async deleteEducation(
    ...
    try {
      this.profileService.removeEduction(
        await userInfo.getUser(["educations"]),
        id
      );
    } catch (e) {
  ...
  public async addProject(
    ...
    try {
      this.profileService.addProject(
        await userInfo.getUser(["projects"]),
        body
      );
    } catch (e) {
      throw new HttpException((<Error>e).message, 400);
  ...
  public async deleteProject(
    ...
    try {
      this.profileService.removeProject(
        await userInfo.getUser(["projects"]),
        id
      );
    } catch (e) {
  ...
  public async addVolunteering(
    ...
    try {
      this.profileService.addVolunteering(
        await userInfo.getUser(["volunteerings"]),
        body
      );
    } catch (e) {
      throw new HttpException((<Error>e).message, 400);
  ...
  public async deleteVolunteering(
    ...
    try {
      this.profileService.removeVolunteering(
        await userInfo.getUser(["volunteerings"]),
        id
      );
    } catch (e) {
  ...
  public async uploadProfilePicture(
    ...
    try {
      const profile_pic = await this.profileService.uploadProfilePicture(
